# MTPLX Technical Notes

Use this folder for implementation notes that are specific to the MTPLX runtime:

- MTP tensor names and shapes.
- Hidden-state contract results.
- Cache rollback design.
